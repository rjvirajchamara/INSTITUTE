...
connection = ConnectionFactory.getInstance().getConnection();
    ...
    private void initComponents() {
        ...
        CourseTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CID", "Coursename", "CourseFee", "Duration", "RegistrationFee", "Cstatas", "Discount"
            }
        ));
        ...
        getContentPane().add(jSeparator14, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 382, 200, 0));
        ...
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(1230, 20, 70, 30));
        ...
        getContentPane().add(btAddStudent, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, 140, 30));
        ...
        getContentPane().add(btUpdateStudent, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 350, 150, 30));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 350, 130, 30));
        ...
        getContentPane().add(txtaFullName, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1460, 820));
    ...
    private void btAddStudentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAddStudentMouseClicked
        try {
            ...
            coure.setCID(txtCid.getText());
            coure.setCoursename(txtcoursename.getText());
            coure.setCourse_fee(new BigDecimal(txtCourseFee.getText()));
            coure.setDuration(TxtDuration.getText());
            coure.setRegfee(txtRegfee.getText());
            coure.setCStatas(txtCstatas.getText());
            coure.setDiscount(new BigDecimal(txtdiscount.getText()));

            //  coure .txtCid.getText(),
    ...
    private void btUpdateStudentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btUpdateStudentMouseClicked
        try {
            ...
            if (result) {
                JOptionPane.showMessageDialog(this, "Course has been successfully updated...!");
            } else {
                JOptionPane.showMessageDialog(this, "Course has not been updated...!");
            }
        } catch (Exception ex) {
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        try {
            JasperReport compiledReport = (JasperReport) JRLoader.loadObject(Startjasper.class.getResourceAsStream("/lk/ijse/studentpayment/view/payment1234.jasper"));
